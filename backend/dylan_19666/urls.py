...
admin.site.site_header = "Dylan"
admin.site.site_title = "Dylan Admin Portal"
admin.site.index_title = "Dylan Admin"

# swagger
api_info = openapi.Info(
    title="Dylan API",
    default_version="v1",
    description="API documentation for Dylan App",
)
